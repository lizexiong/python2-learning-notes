...
'''
        ...
        AbstractSchool   BJSchool(abstractSchool)  SHSchool(abstractSchool)
        AbstractCourse   LinuxOPSCourse(AbstractCourse)  PythonCourse(AbstractCourse)

    上面是 6个类的关系，只要这个清楚了，这个模式就理解了

    上海人员可以注册北京课程，这样没有依赖关系，可以随便调用
...
school1.enroll('李泽雄',c1)

school2.info()
c2 = school2.create_course('linux')
school2.enroll('吴鑫哲',c2)