    ...
    def get_latest_60mins_trends(self):
        ...
        for key in self.__collection_items:
            ...
            while time_counter >0:
                ...
                print ('each_miute_data',each_minute_data)
                ...
                #print('key,tmp_data[key]',key,tmp_data[key])

            else:
                print(data)
        self.data['latest_60mins_trends'] = tmp_data
        # for i,j in tmp_data.items():
        #     print (i,'----------------------------------------------------------',j)
        #print ('----tmp_data',tmp_data,'data',data)
        return data
